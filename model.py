...
class MNISTDiffusion(nn.Module):
    ...
    def sampling(self, n_samples, clipped_reverse_diffusion=True, device="cuda"):
        x_t = torch.randn(
            (n_samples, self.in_channels, self.image_size,
    ...
    def _forward_diffusion(self, x_0, t, noise):
        ...
        # q(x_{t}|x_{t-1})
        return (
            self.sqrt_alphas_cumprod.gather(-1,
                                            t).reshape(x_0.shape[0], 1, 1, 1)
            * x_0
    ...
    def _reverse_diffusion_with_clip(self, x_t, t, noise):
        ...
        if t.min() > 0:
            ...
            mean = (
                ...
                * x_0_pred
                + ((1.0 - alpha_t_cumprod_prev) *
                   torch.sqrt(alpha_t) / (1.0 - alpha_t_cumprod))
                * x_t
            )
            ...
            # alpha_t_cumprod_prev=1 since 0!=1
            std = 0.0
